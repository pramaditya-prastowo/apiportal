...
public class DataApiClient {
    ...
    public static final String SIGNATURE_AUTH = "Signature Auth";
    ...
    public ResponseApiGw signatureAuth(String url, RequestHeaderApi requestHeader, String requestBody){
        ...
        request.setHeader("Private_Key", requestHeader.getPrivateKey());
        ...
        try (CloseableHttpResponse response = httpClient.execute(request)) {
            ...
            logService.logApiGw(request.getAllHeaders(), new HashMap<>(),
                    responseData,SIGNATURE_AUTH,
...
//        request.setHeader(HttpHeaders.AUTHORIZATION, "Bearer "+ requestHeader.getBearerToken());
        request.setHeader("X-CLIENT-SECRET", requestHeader.getClientSecret());
        request.setHeader("X-TIMESTAMP", requestHeader.getTimestamp());
        request.setHeader("AccesToken", requestHeader.getAccessToken());
        request.setHeader("EndpointUrl", requestHeader.getEndPointUrl());
    ...
    public ResponseApiGw balanceInquiry(String url, RequestHeaderApi requestHeader, String requestBody){
        ...
        request.setHeader(HttpHeaders.CONTENT_TYPE, ContentType.APPLICATION_JSON.getMimeType());
        request.setHeader(HttpHeaders.AUTHORIZATION, "Bearer "+ requestHeader.getAccessToken());
        request.setHeader("X-SIGNATURE", requestHeader.getSignature());
        request.setHeader("X-TIMESTAMP", requestHeader.getTimestamp());
